    ...
    return (
      <div className="page">
        <header className="page-head">
          <h1>計算ドリル</h1>
          <p className="lead">
            出題のたびに数値が変わる自動生成問題です。同じ問題を暗記するのではなく、計算の手順そのものを身に付けるための練習で、何問でも続けられます。★ 令和 7 年度の学識で、値を出させる計算問題は化学が 15 問中 4 問、機械は 15 問中 1 問でした。「学識は計算が中心」ではありません。それでも手を動かしておく値打ちはあります。化学では典型的な計算がいくつも出ますし、機械では、式のどの項が何に効くかを問う設問を落ち着いて読むための土台になります。
          </p>
        </header>
